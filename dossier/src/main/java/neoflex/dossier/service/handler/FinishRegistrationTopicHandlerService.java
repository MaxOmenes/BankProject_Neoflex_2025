...
public class FinishRegistrationTopicHandlerService implements TopicHandler<EmailMessageDto> {
    ...
    public void handle(EmailMessageDto message) {
        ...
        String emailContent = templateEngine.process(Templates.FINISH_REGISTRATION.getPath(), context);

        emailSenderService.sendEmail(message.getAddress(), "Finish your registration | Bank with Love", emailContent);
    }
}
