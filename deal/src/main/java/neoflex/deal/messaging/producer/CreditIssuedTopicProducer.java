...
public class CreditIssuedTopicProducer implements TopicProducer<EmailMessageDto> {

    private final KafkaTemplate<String, Object> kafkaTemplate;

    @Override
    public void send(EmailMessageDto message) {
        kafkaTemplate.send(Topic.CREDIT_ISSUED.getName(), message.getStatementId().toString(), message);
