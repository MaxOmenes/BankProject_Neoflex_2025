...
public class CreateDocumentsTopicProducer implements TopicProducer<EmailMessageDto> {

    private final KafkaTemplate<String, Object> kafkaTemplate;

    @Override
    public void send(EmailMessageDto message) {
        kafkaTemplate.send(Topic.CREATE_DOCUMENTS.getName(), message.getStatementId().toString(), message);
